...
public class PatchLevel {
	...
	public static final String COPYRIGHT_BANNER_A = "NetHack, Copyright 1985-2019";
	public static final String COPYRIGHT_BANNER_B = "         By Stichting Mathematisch Centrum and M. Stephenson.";
	public static final String COPYRIGHT_BANNER_C = "         Version {MAJOR}.{MINOR}.{PATCH} Unix, built Jan 01 00:00:00 1970."
			.replace("{MAJOR}", Integer.toString(VERSION_MAJOR))
			.replace("{MINOR}", Integer.toString(VERSION_MINOR))
			.replace("{PATCH}", Integer.toString(PATCHLEVEL));
	public static final String COPYRIGHT_BANNER_D = "         See license for details.";
	
	public static final void main(String args[])
	{
		System.out.println(COPYRIGHT_BANNER_A);
		System.out.println(COPYRIGHT_BANNER_B);
		System.out.println(COPYRIGHT_BANNER_C);
		System.out.println(COPYRIGHT_BANNER_D);
	}
