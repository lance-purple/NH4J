...
int wereCreatureSummonsOtherMonsters(wpmid, yours, visible, genbuf)
int wpmid;
...
boolean youHateSilver() {
    return (lycanthropeType() >= LOW_PM || monsterTypeHatesSilver(pmid4you()));
}
