...
extern javaString roleNameAsMale(int whichRole) {
  jstring j_str = javaGetStringFromInt(ADVENTURER_ROLE_CLASS, "roleNameAsMale", whichRole);
  const char* c_str = (*jni_env)->GetStringUTFChars(jni_env, j_str, NULL);
  javaString result = { j_str, c_str };
  return result;
}

extern boolean roleNameHasFemaleVersion(int whichRole) {
    return javaGetBooleanFromInt(ADVENTURER_ROLE_CLASS, "roleNameHasFemaleVersion", whichRole);
}

extern javaString roleNameAsFemale(int whichRole) {
  jstring j_str = javaGetStringFromInt(ADVENTURER_ROLE_CLASS, "roleNameAsFemale", whichRole);
  const char* c_str = (*jni_env)->GetStringUTFChars(jni_env, j_str, NULL);
  javaString result = { j_str, c_str };
  return result;
}

extern boolean rankNameHasMaleVersion(int whichRole, int whichRank) {
    return javaGetBooleanFromIntAndInt(ADVENTURER_ROLE_CLASS, "rankNameHasMaleVersion", whichRole, whichRank);
}

extern javaString rankNameAsMale(int whichRole, int whichRank) {
  jstring j_str = javaGetStringFromIntAndInt(ADVENTURER_ROLE_CLASS, "rankNameAsMale", whichRole, whichRank);
  const char* c_str = (*jni_env)->GetStringUTFChars(jni_env, j_str, NULL);
  javaString result = { j_str, c_str };
  return result;
}

extern boolean rankNameHasFemaleVersion(int whichRole, int whichRank) {
    return javaGetBooleanFromIntAndInt(ADVENTURER_ROLE_CLASS, "rankNameHasFemaleVersion", whichRole, whichRank);
}
...
int pmidOfQuestEnemiesForYourRole() {
  return javaGetInt(PLAYER_CHARACTER_CLASS, "pmidOfQuestEnemies");
}

int pmidOfOtherQuestEnemiesForYourRole() {
...
int attributeBaseForYourRole(int whichAttr) {
...
extern int ACHIEVEMENT_GOT_AMULET() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "GOT_AMULET");
}

extern int ACHIEVEMENT_GOT_BELL() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "GOT_BELL");
}

extern int ACHIEVEMENT_GOT_BOOK() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "GOT_BOOK");
}

extern int ACHIEVEMENT_GOT_CANDELABRUM() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "GOT_CANDELABRUM");
}

extern int ACHIEVEMENT_ENTERED_GEHENNOM() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "ENTERED_GEHENNOM");
}

extern int ACHIEVEMENT_ASCENDED() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "ASCENDED");
}

extern int ACHIEVEMENT_FOUND_LUCKSTONE_IN_MINES() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "FOUND_LUCKSTONE_IN_MINES");
}

extern int ACHIEVEMENT_FINISHED_SOKOBAN_LEVEL() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "FINISHED_SOKOBAN_LEVEL");
}

extern int ACHIEVEMENT_KILLED_MEDUSA() {
  return javaGetInt(ACHIEVEMENT_TYPE_CLASS, "KILLED_MEDUSA");
}

extern int SPECIAL_ITEM_AMULET() {
  return javaGetInt(SPECIAL_ITEM_CLASS, "AMULET");
}

extern int SPECIAL_ITEM_BELL() {
  return javaGetInt(SPECIAL_ITEM_CLASS, "BELL");
}

extern int SPECIAL_ITEM_BOOK() {
  return javaGetInt(SPECIAL_ITEM_CLASS, "BOOK");
}

extern int SPECIAL_ITEM_CANDELABRUM() {
  return javaGetInt(SPECIAL_ITEM_CLASS, "CANDELABRUM");
}

extern int SPECIAL_ITEM_QUEST_ARTIFACT() {
  return javaGetInt(SPECIAL_ITEM_CLASS, "QUEST_ARTIFACT");
}

extern javaString alignmentString(int index) {
  jstring j_str = javaGetStringFromInt(ROLE_ALIGNMENT_CLASS, "alignmentString", index);
  const char* c_str = (*jni_env)->GetStringUTFChars(jni_env, j_str, NULL);
  javaString result = { j_str, c_str };
  return result;
}
...
extern int maleMask() {
  return javaGetInt(GENDER_CLASS, "maleMask");
}

extern int femaleMask() {
  return javaGetInt(GENDER_CLASS, "femaleMask");
}

extern int neuterMask() {
